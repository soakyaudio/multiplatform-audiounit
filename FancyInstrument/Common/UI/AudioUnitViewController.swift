...
private let log = Logger(subsystem: "com.soakyaudio.FancyAudioApp.FancyInstrument", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<FancyInstrumentMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try FancyInstrumentAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? FancyInstrumentAudioUnit else {
            log.error("Unable to create FancyInstrumentAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(FancyInstrumentParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = FancyInstrumentMainView(parameterTree: observableParameterTree)
