...
#import "FancyInstrumentAUProcessHelper.hpp"
#import "FancyInstrumentDSPKernel.hpp"


// Define parameter addresses.

@interface FancyInstrumentAudioUnit ()
...
@implementation FancyInstrumentAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    FancyInstrumentDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block FancyInstrumentDSPKernel *kernel = &_kernel;
