...
#import "FancyInstrument-Swift.h"
#import "FancyInstrumentParameterAddresses.h"

/*
 FancyInstrumentDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class FancyInstrumentDSPKernel {
public:
    ...
    // Add a case for each parameter in FancyInstrumentParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case FancyInstrumentParameterAddress::gain:
                mGain = value;
                break;
        }
    }
    ...
    void handleMIDIEventList(AUEventSampleTime now, AUMIDIEventList const* midiEvent) {
        auto visitor = [] (void* context, MIDITimeStamp timeStamp, MIDIUniversalMessage message) {
            auto thisObject = static_cast<FancyInstrumentDSPKernel *>(context);
